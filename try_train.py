...
from handcraft.model import Predictor, Action_encoder, MLP, SIGReg
...
def run(cfg):
    ...
    predictor = Predictor(
        num_frame=cfg.wm.history_size,
        in_dim=embed_dim,
        hidden_dim=hidden_dim,
        out_dim=hidden_dim,
        mlp_dim=cfg.predictor.mlp_dim,
        head=cfg.predictor.heads,
        head_dim=cfg.predictor.dim_head,
        dropout=cfg.predictor.dropout,
        depth=cfg.predictor.depth,
        emb_dropout=cfg.predictor.emb_dropout
    )

    action_encoder = Action_encoder(in_dim=effective_act_dim, hidden_dim=embed_dim, out_dim=embed_dim)
